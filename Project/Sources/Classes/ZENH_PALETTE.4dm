...
Function palette_get($is_record : Boolean)->$vJ_palette : Object
	...
	$vJ_palette.l_font_color:=k_MD_black-2
	$vJ_palette.l_font_size:=14
	$vJ_palette.l_font_style:=Bold:K14:2
	//$vJ_palette.l_centered:=0
	
	//$vJ_palette.r_angle_start:=0
	//$vJ_palette.r_angle_end:=0  //-Pi/2
	$vJ_palette.r_angle_start:=-Pi:K30:1
	$vJ_palette.r_angle_end:=0
	$vJ_palette.r_scale:=2  //2.6
	//$vJ_widget.l_timer:=1
	//$vJ_widget.r_increment:=0.1
	//$vJ_widget.l_curve:=4 // Default 4
	//$vJ_widget.is_close:=False
	...
	$vJ_pattern.is_editing:=False:C215
	$vJ_pattern.l_pattern:=23
	$vJ_pattern.l_colors:=0x908E
	$vJ_pattern.l_rxy:=15
	$vJ_pattern.l_stroke:=3
	$vJ_pattern.l_opacity:=90
	
	This:C1470.palette_build($vJ_palette; $is_record)
	// *
	// *****
	
	
Function palette_build($vJ_palette : Object; $is_record : Boolean)
...
Function _menu_modules($vC_aj_palette : Collection; $vt_path_icn : Text)
	...
	var $idx; $vL_colors; $vL_table_colors : Integer

...
Function lb_active_img($cE_sessions : cs:C1710.SESSIONSEntity)->$vO_img : Picture  // Form.fc.lb_active_img(This)
	$vO_img:=This:C1470.get_icon_img($cE_sessions.isActive)
	
	
Function lb_colors_img($cE_sessions : cs:C1710.SESSIONSEntity)->$vO_img : Picture
	var $vL_colors; $vL_size; $vL_shape : Integer
	$vL_colors:=$cE_sessions.colors
	$vL_shape:=-3
	$vL_size:=20

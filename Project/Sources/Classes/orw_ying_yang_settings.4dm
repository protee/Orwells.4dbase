...
Class constructor
	Super:C1705("j_yin_yang_settings")
...
Function _init()
	...
	$vC_at_widget.push("coef"; "angle"; "stroke"; "coef_dots"; "gap")
	This:C1470._at_waz_l:=$vC_at_widget
	
	$vC_at_widget:=New collection:C1472()  // orw j_
	$vC_at_widget.push("yin"; "yang")
	This:C1470._at_orw_j:=$vC_at_widget
	
	$vC_at_widget:=New collection:C1472()  // waz is_
	$vC_at_widget.push("reverse"; "bkg_ellipse"; "bkg")

...
Function yinYang_draw($cE_YING_YANG : cs:C1710.YIN_YANGEntity)->$vO_img : Picture
	var $vL_width; $vL_height : Integer
	var $vJ_fields : Object
	$vL_width:=64
	$vL_height:=64
	$vJ_fields:=$cE_YING_YANG.fields
	$vO_img:=orw_yinYang_svg($vL_width; $vL_height; $vJ_fields)

...
// ***** waz_Bazar IO colors
// *
var $vJ_waz_widgets : Object
$vJ_waz_widgets:=waz__storage_widgets()
...
$vJ_io_progress:=$vJ_waz_widgets.j_io_progress
Use ($vJ_io_progress)
...
$vT_filter_time:="##:##:##"
Use ($vJ_waz_widgets)
	$vJ_waz_widgets.j_date.t_filter:=$vT_filter_date
	$vJ_waz_widgets.j_dates.t_filter:=$vT_filter_date
	$vJ_waz_widgets.j_time.t_filter:=$vT_filter_time
	$vJ_waz_widgets.j_times.t_filter:=$vT_filter_time
	$vJ_widget:=$vJ_waz_widgets.j_datetime

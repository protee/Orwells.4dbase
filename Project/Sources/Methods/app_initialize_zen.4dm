...
Use ($vJ_prefs)
	...
	zen__add_tree_duplicate($vJ_relate_many_dup; "SESSIONS"; "SPEECHES")
	zen__add_tree_duplicate($vJ_relate_many_dup; "SPEECHES"; "FRAGMENTS"; "ACTIONS")
	zen__add_tree_duplicate($vJ_relate_many_dup; "CATEGORIES"; "ORWELLS")

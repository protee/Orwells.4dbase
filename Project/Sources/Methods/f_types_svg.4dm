...
var $is_value; $is_inverse; $is_selected; $is_bold : Boolean
var $vL_left; $vL_top; $vL_right; $vL_bottom; $vL_svg_width; $vL_svg_height; $vL_tt; $vL_app_width; $x; $vL_r; $vL_size; $y; $vL_stroke; $i; $idx; $vL_strokeD2; $x1 : Integer
var $vT_svg_root; $vT_stroke_txt; $vT_fill_txt; $vT_svg_group; $vT_font_face : Text
...
For ($i; 1; $vL_tt)
	...
	SVG_New_text($vT_svg_group; $vC_lbl[$idx]; ($x1-$x)/2+$x; $y; $vT_font_face; $vL_size; Num:C11($is_bold); 3; $vT_stroke_txt)
	$x:=$x1
End for 
